* ERA5 hourly temperature (NetCDF, template)
* Grid: 0.25 x 0.25 deg global, 37 pressure levels
* Files: one per month, e.g. era5_hourly_temperature_YYYYMM.nc
* Real path (no symlinks) for Slurm compatibility
*
DSET /lustre/soge1/data/analysis/era5/0.28125x0.28125/hourly/temperature/nc/era5_hourly_temperature_%y4%m2.nc
DTYPE netcdf
OPTIONS template yrev
TITLE ERA5 hourly temperature
UNDEF -32767
