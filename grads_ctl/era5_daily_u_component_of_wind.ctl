* ERA5 daily U component of wind (NetCDF, template)
* Grid: 0.25 x 0.25 deg global, 37 pressure levels
* Files: one per year, e.g. era5_daily_u_component_of_wind_YYYY.nc
* Real path (no symlinks) for Slurm compatibility
*
DSET /lustre/soge1/data/analysis/era5/0.28125x0.28125/daily/u_component_of_wind/nc/era5_daily_u_component_of_wind_%y4.nc
DTYPE netcdf
OPTIONS template yrev
TITLE ERA5 daily U component of wind
UNDEF -32767
