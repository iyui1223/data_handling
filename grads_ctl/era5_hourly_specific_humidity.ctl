* ERA5 hourly specific humidity (NetCDF, template)
* Grid: 0.25 x 0.25 deg global, 37 pressure levels
* Files: one per month, e.g. era5_hourly_specific_humidity_YYYYMM.nc
* Real path (no symlinks) for Slurm compatibility
*
DSET /lustre/soge1/data/analysis/era5/0.28125x0.28125/hourly/specific_humidity/nc/era5_hourly_specific_humidity_%y4%m2.nc
DTYPE netcdf
OPTIONS template yrev
TITLE ERA5 hourly specific humidity
UNDEF -32767
...
VARS 1
q 37 t,z,y,x Specific humidity [kg kg**-1]
ENDVARS
