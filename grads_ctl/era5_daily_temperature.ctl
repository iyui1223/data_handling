* ERA5 daily temperature (NetCDF, template)
* Grid: 0.25 x 0.25 deg global, 37 pressure levels
* Files: one per month, e.g. era5_daily_temperature_YYYY_MM.nc
* Real path (no symlinks) for Slurm compatibility
*
DSET /lustre/soge1/data/analysis/era5/0.28125x0.28125/daily/temperature/nc/era5_daily_temperature_%y4_%m2.nc
DTYPE netcdf
OPTIONS template yrev
TITLE ERA5 daily temperature
UNDEF -32767
